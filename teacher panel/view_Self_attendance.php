...
const weekday = ["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"];
    ...
    <title>KnowledgeAcademy-TeacherAttendanceView</title>
  ...
  <body>
   ...
   if($row['ClassTeacher']=="")
   {
    ...
    <div class="col-md-6 attendance_chart_container">
      ...
      <?php
        $sql="select * from teacher_attendance where status='present' and teacher_id='".$id."'";
        $result1=mysqli_num_rows(mysqli_query($conn,$sql));
        $sql="select * from teacher_attendance where status='absent' and teacher_id='".$id."'";
        $result2=mysqli_num_rows(mysqli_query($conn,$sql));
        $sql="select * from teacher_attendance where status='late' and teacher_id='".$id."'";
        $result3=mysqli_num_rows(mysqli_query($conn,$sql));
        $sql="select * from teacher_attendance where status='half_day' and teacher_id='".$id."'";
    ...
    $("#next").click(function(e){
        ...
        call_for_table();
             ...
             function call_for_chart(){
               ...
               $.ajax({
                 ...
                 data: {func:'monthly_attendance_chart',teacher_id:id,i:i},
      ...
      function call_for_table(){
        ...
        $.ajax({
          type: "POST",
          url: 'teacher_submit.php',
          data: {func:'monthly_attendance_table',teacher_id:id,i:i},
