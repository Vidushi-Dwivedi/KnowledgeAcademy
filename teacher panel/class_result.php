  ...
  <head>
    ...
    <div class="col col-lg-9 third_col">
      <div class="container-fluid ">
        <div class="brand">
          <i class="fas fa-search"></i><span class="heading">Search Class Result</span>
        </div>
      </div>
         ...
         <div class="form_contain" id="student_attendance_form">
            <form  id="search_result" >
                ...
                <div class="col formgroup container-fluid">
                    <label class="la col-form-label" for="class_id">Class* </label>
                    <select class=" form-control form-control-lg" id="Class" name="class_id" required>
                    <?php
                        $sql= "SELECT Id, Class, Sec from class where Id in (select ClassId from teaches where TeacherId='".$id."')";
                        $res=mysqli_query($conn,$sql);
                        while($row1=mysqli_fetch_array($res)){
                          ?>
                          <option class="opt" value="<?php echo $row1['Id'] ?>"><?php echo $row1['Class'] ?> - <?php echo $row1['Sec'] ?></option>
                          <?php
                        }
                     ?>
                   </select>
...
<script type="text/javascript">
     ...
     $(document).ready(function () {
          var dataTable = $('#student_attendance').DataTable({
              ...
              "ajax": {
                  ...
                  data: {func: 'pagination', page:'class_result',class:c_id,exam:exam,year:year,TeacherId:t}, // Set the POST variable  array and adds action: getEMP
   ...
   //         data: {func:'search_result',class:c_id,exam:exam,year:year},
