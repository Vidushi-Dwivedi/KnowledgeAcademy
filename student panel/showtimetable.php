...
<head>
    ...
    <title>Syllabus Timetable</title>
  ...
  $row1=mysqli_fetch_array($result);
   ...
   <div class="col-lg-9 middle_col">
    ...
    <div class = "container">
        <div class ="col-12">
        <h1 class="text-head text-center text-white bg-dark"> Time Table </h1>
        <br>
...
$queryd1 = mysqli_fetch_array(mysqli_query($con,$query1));
$query = "select `ClassId`,`TimeTable` from `ClassInfo1` where `ClassId`='".$queryd1["ClassID"]."'";
