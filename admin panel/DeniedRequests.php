...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>KnowledgeAcademy-DeniedLeave</title>
    ...
    <a class="navbar-brand">
     <i class="fas fa-clipboard-check"></i><span class="notice_heading">DENIED LEAVE REQUESTS</span>
    </a>
    </div>
    </nav>
    ...
    $(document).ready(function () {
      ...
      var dataTable = $('#notices').DataTable({
          ...
          "ajax": {
              ...
              data: {func: 'pagination', page:'denied_leave_requests',s_id:sid}, // Set the POST variable  array and adds action: getEMP
