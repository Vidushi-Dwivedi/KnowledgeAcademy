...
<hr />
    ...
    <div class = "container">
        <div class ="col-12">
        <h1 class="text-center text-white bg-dark"> Student list </h1>
        <br>
...
while($result = mysqli_fetch_array($queryd) ){
  $sql="select * from class where Id='".$result['ClassID']."'";
  $row= mysqli_fetch_assoc(mysqli_query($con,$sql));
  $sql="select * from class where Id='".$result['admission_class']."'";
  $row1= mysqli_fetch_assoc(mysqli_query($con,$sql));
    ...
    <tr>
      ...
      <td> <?php echo $row1['Class']." - ".$row1['Sec']; ?> </td>
        <td><a class="icon" href="updatestudent.php?id=<?php echo $result['Id'] ?>"><i class="fa fa-edit "></i></a></td>
