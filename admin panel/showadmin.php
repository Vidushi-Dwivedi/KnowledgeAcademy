  ...
  <div class="row">
    <div class="col-lg-4 col-md-6">
      <button type="button"  class="btn btn-light add_notice" >
       ...
       <a class="btn-text" href="addadmin1.php"> Add Admin</a>
     </button>
    </div>
...
<hr />
    ...
    <div class = "container">
    <center>
        <table class="table table-striped table-hover" id="admin_paging">
            <thead>
                <th> ID </th>
                <th> Role </th>
                <th> Name </th>
...
$(document).ready(function () {
       var dataTable = $('#admin_paging').DataTable({
           "responsive": true,
           "processing": true,
           "serverSide": true,
           "ajax": {
               url: "submit.php", // json datasource
               data: {func: 'pagination', page:'admin_paging'}, // Set the POST variable  array and adds action: getEMP
