...
<html lang="en" dir="ltr">
  <head>
    ...
    <?php include 'db.php' ?>
    <title>KnowledgeAcademy-StaffDropoutForm</title>
    <style media="screen">
    body {
    font-size: 16px;
    line-height: 1.8;
  ...
  function checkt(){
    ...
    var numbers = new RegExp("/^\d+$/");
      if( /^\d+$/.test(id)){
        ...
        document.getElementById("id").setCustomValidity("Invalid StudentID. It should be a number.");
      }
    if(reason==""){
      ...
      $('#register-form').on('submit', function(e){
          ...
          if(checkt()){
            ...
            $.ajax({
              type: "POST",
              url: 'submit.php',
              data: {func:'dropout_staff_form',staff_id:id,reason:reason,role:role},
