...
<html lang="en" dir="ltr">
  <head>
    ...
    <?php include 'db.php' ?>
    <title>KnowledgeAcademy-Subjects</title>
    <style media="screen">
  ...
  <body>
    ...
    <a class="navbar-brand">
      <span class="notice_heading"><i class="fas fa-swatchbook"></i>Subject</span>
    </a>
    <div class="">
      <a href="add_subject.php"> <button class="btn btn-outline-info" type="button" name="button">Add Subject</button> </a>
    ...
    $(document).ready(function () {
         var dataTable = $('#teaches').DataTable({
             ...
             "ajax": {
                 ...
                 data: {func: 'pagination', page:'subjectlist'}, // Set the POST variable  array and adds action: getEMP
