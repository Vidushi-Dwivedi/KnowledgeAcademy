          ...
          <form method="POST" class="register-form" id="register-form" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <?php  $id=$_GET['id'];?>
                        ...
                        <h2 class="text-center">Student details updation</h2>
                        <?php
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="classid" id="classid" >
                              <?php
                               ...
                               ?>
                               <option value="<?php echo $r['Id'] ?>" <?php if($result['ClassID']==$r['Id']){ echo "selected";} ?>><?php echo $r['Class']." - ".$r['Sec'] ?></option>
                             <?php } ?>
                            </select>
                        </div>
                        <div class="form-group">
...
<input type="file" name="file" id="file" value="<?php echo $result['Photograph']; ?>" class="form-control" />
  ...
  <div class="form-submit d ">
      <a href="student_paging.php?i=0"><input type="button" value="SHOW ALL" class="submit" name="update" id="update" class="btn btn-success" /> </a> </td>
